...
<!--        <div v-show="domain != ''" class="fl1" style="display: flex;">-->
<!--          <div class="search1">-->
<!--            <el-input-->
<!--                placeholder="请输入文本"-->
<!--                v-model="nodeName"-->
...
<!--                @keyup.enter.native="getDomainGraph"-->
<!--            ></el-input>-->
<!--            <el-button @click="getDomainGraph(0)" class="btn-large">-->
<!--              <svg class="icon" aria-hidden="true">-->
<!--                <use xlink:href="#icon-search"></use>-->
<!--              </svg>-->
<!--            </el-button>-->
...
.mind-top1 {
  ...
  height: 150px;
  padding: 0 22px;
  justify-content: center; /* 确保按钮和文本框在同一行 */
...
.btn-large {
  ...
  background-color: #f56c6c; /* 设置按钮背景颜色为红色 */
  color: white; /* 设置按钮文字颜色为白色 */
  font-size: 16px; /* 设置按钮文字大小为16px */
  line-height: 50px; /* 设置按钮文字垂直居中 */
}

.text-box-large {
  width: 100%; /* 设置宽度为父元素的100%，以适应更大的文本框 */
  height: 50px; /* 设置高度为50px */
  border-radius: 32px;
  border: none; /* 移除边框 */
  background-color: #f7f7f7; /* 设置背景颜色为浅灰色 */
  padding: 0 10px; /* 设置内边距为10px */
