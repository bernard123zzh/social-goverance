      ...
      navList: [
        {
          ...
          linkUrl: "https://cscw.fudan.edu.cn/sysjj/list.htm",
          active: false,
          childrens: []
        },
        {
...
.menu { height: 100px; width: 100%; background-color: #000; }
.nav { height: 80px; width: 100%; margin: 0 auto; }
.nav li { float: left; position: relative; }
.nav li a { color: #bdbdbd; padding: 0 50px; display: inline-block; text-decoration:none}
...
.logo { float: left;margin-left: 70px;width: 500px;font-size: 26px;padding: 8px;}
